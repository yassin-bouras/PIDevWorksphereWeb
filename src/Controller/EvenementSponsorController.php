...
final class EvenementSponsorController extends AbstractController{
    ...
    #[Route('/{evenement_id}', name: 'app_evenement_sponsor_show', methods: ['GET'])]
    public function show(EvenementSponsor $evenementSponsor): Response
    {
    ...
    #[Route('/{evenement_id}/edit', name: 'app_evenement_sponsor_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, EvenementSponsor $evenementSponsor, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(EvenementSponsorType::class, $evenementSponsor);
        $form->handleRequest($request);
    ...
    #[Route('/{evenement_id}', name: 'app_evenement_sponsor_delete', methods: ['POST'])]
    public function delete(Request $request, EvenementSponsor $evenementSponsor, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$evenementSponsor->getEvenement_id(), $request->getPayload()->getString('_token'))) {
